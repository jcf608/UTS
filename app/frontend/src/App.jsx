        ...
        <div className="bg-white rounded-lg shadow-sm border-l-4 border-[#8BA3B8] p-6">
          ...
          >
            ...
            <p className="mt-3 text-sm text-[#636366]">
              {uploading ? 'Processing...' : 'Drop PNG or SVG files here or click to browse'}
            </p>
            <p className="mt-1 text-xs text-[#8E8E93]">
              {uploading ? '' : 'Only PNG and SVG image files are supported'}
            </p>
            <button 
            ...
            >
              {uploading ? 'Processing...' : 'Select PNG or SVG Files'}
            </button>
          </div>
